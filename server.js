...
async function persistDailyCounters(body) {
  ...
  const counters = Array.isArray(body.counters) ? body.counters : [{
    ...
    danmuFailedToday: body.danmuFailedToday,
    discussionFailedToday: body.discussionFailedToday,
    danmuSkippedToday: body.danmuSkippedToday,
  ...
  await enqueueWrite(async () => {
    for (const raw of counters) {
      ...
      await updateGithubCounter(date, weiboNickname, deviceHash, {
        danmuSentToday: count(raw.danmuSentToday, 0),
        discussionSentToday: count(raw.discussionSentToday, 0),
        danmuFailedToday: count(raw.danmuFailedToday, 0),
        discussionFailedToday: count(raw.discussionFailedToday, 0),
        danmuSkippedToday: count(raw.danmuSkippedToday, 0),
